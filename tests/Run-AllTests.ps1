...
$suites = @(
    ...
    @{ Name = "BatchRenameFiles";        File = "BatchRenameFiles.Tests.ps1";        RequiresCom = $true },
    ...
    @{ Name = "BatchConvertWordToPDF";   File = "BatchConvertWordToPDF.Tests.ps1";   RequiresCom = $true },
