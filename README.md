...
Ribbon 的「宏列表」区域提供快捷悬浮窗入口。悬浮窗不会阻塞文档编辑，可拖动到合适位置，并会记住上次位置。界面复用 Ribbon 中相同功能的按钮图标，以紧凑、精确居中的纵向图标块呈现，鼠标悬停可查看功能名称及操作说明；v0.7.0 内置标题 1-3、正文、文字设为蓝色、段前分页、表格自动适应窗口及科学术语下标标准化等高频操作。
